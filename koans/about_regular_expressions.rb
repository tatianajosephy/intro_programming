...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_slash_b_anchors_to_a_word_boundary # need help here
  ...
  def test_variables_can_also_be_used_to_access_captures # need help here
  ...
  def test_a_vertical_pipe_means_or # need help here (could just call [grays, 1])
  ...
  def test_scan_is_like_find_all # learn more about scan
    assert_equal ["one", "two", "three"], "one two-three".scan(/\w+/)
  end

  def test_sub_is_like_find_and_replace #what the heck is this???
