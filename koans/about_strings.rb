...
class AboutStrings < EdgeCase::Koan
  ...
  def test_use_single_quotes_to_create_string_with_double_quotes #help
    string = 'He said, "Go Away."'
    assert_equal 'He said, "Go Away."', string
  end

  def test_use_double_quotes_to_create_strings_with_single_quotes #help
    string = "Don't"
    assert_equal "Don't", string
  end

  def test_use_backslash_for_those_hard_cases #help
    a = "He said, \"Don't\"" 
    b = 'He said, "Don\'t"'
...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string #help
    original_string = "Hello, "
    hi = original_string
    there = "World"
    hi << there
  ...
  def test_single_quotes_sometimes_interpret_escape_characters #help
    string = '\\\''
    assert_equal 2, string.size
    assert_equal '\\\'', string
  end
  ...
  def test_single_quoted_strings_do_not_interpolate # need double quotes then for variables?
    value = 123
    string = 'The value is #{value}'
  ...
  in_ruby_version("1.9") do
    def test_in_ruby_1_9_single_characters_are_represented_by_strings # just a ruby version thing?
      assert_equal "a", ?a
